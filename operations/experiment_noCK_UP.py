...
if __name__ == '__main__':
    ...
    for i in range(n_exp):
        ...
        for j, flag in enumerate(flag_grid):
            ...
            X_att = attack_set_UP(X_test, y_test, params) #attack_set(X_test, y_test, params)
        ...
        name = "results/sentiment_2/exp_classifiers_noCK_UP/" + "exp_classifiers_noCK_UP_" + str(i) + ".csv"
